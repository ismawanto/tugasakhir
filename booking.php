...
$dataSopir = $koneksi->query("SELECT * FROM sopir")->fetchAll(PDO::FETCH_ASSOC);
?>
<br>
<br>
<div class="container">
    ...
    <div class="col-sm-4">
      <div class="card">
        ...
        <div class="card-body" style="background:#ddd">
          ...
          <h5 class="card-title"><?php echo $isi['tipe']; ?></h5>
          <p class="card-title"><?php echo $isi['transmisi']; ?></p>
        </div>
        ...
        <div class="card-body">
          <form method="post" action="koneksi/proses.php?id=booking">
            ...
            <div class="form-group">
              ...
              <input type="datetime-local" name="tanggal" id="" required class="form-control">
            </div>
            <div class="form-group">
            ...
            <!-- <div class="form-group">
              ...
              <select name="id_sopir" class="form-control">
                <option value="">Tanpa Sewa Supir</option>
                <?php foreach ($dataSopir as $sopir) { ?>
                  <option value="<?php echo $sopir['id_sopir']; ?>"><?php echo $sopir['nama_sopir']; ?></option>
                <?php } ?>
              </select>
            </div> -->
            ...
            <hr />
            <?php if ($isi['status'] == 'Tersedia') { ?>
              <button type="submit" class="btn btn-primary float-right">Booking Sekarang</button>
            <?php } else { ?>
              <button type="submit" class="btn btn-danger float-right" disabled>Booking Sekarang</button>
            <?php } ?>
          </form>
        </div>
      </div>
