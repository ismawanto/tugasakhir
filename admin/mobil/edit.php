                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <select class="form-control col-sm-9" name="merk">
                                    <option value="<?= $hasil['merk'];?>"  selected><?= $hasil['merk'];?></option>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3">Jenis Mobil</label>
                                <input type="text" class="form-control col-sm-9" name="tipe" placeholder="Isi Jenis Mobil" value="<?= $hasil['tipe'];?>">
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Tipe Transmisi</label>
                                <select class="form-control col-sm-9" name="transmisi">
                                    <option value="<?= $hasil['transmisi'];?>" selected><?= $hasil['transmisi'];?></option>
