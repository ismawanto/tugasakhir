                ...
                <table class="table table-striped table-bordered table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $isi['merk'];?></td>
                            <td><?= $isi['nama'];?></td>
                            <td><?php   $datetime = new DateTime($isi['tanggal']);   echo $datetime->format('Y-m-d H:i:s');?></td>
                            <td>
                            <?php
                               $datetime = new DateTime($isi['tanggal']);
                               $interval = new DateInterval('PT' . $isi['lama_sewa'] . 'H');
